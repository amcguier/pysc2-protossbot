...
#import tensorflow.python.data.Dataset as Dataset
import matplotlib.pyplot as plt

training_data = pd.read_csv("W:/Documents/Protoss_Training_Data.csv")
...
linear_regressor = train_linear_regressor_model(learning_rate=0.00001, steps=200, batch_size=20, 
