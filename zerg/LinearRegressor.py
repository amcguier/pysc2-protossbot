...
training_data = pd.read_csv('/Users/vinnyveeramachaneni/Desktop/testOutput1', sep=',')
...
def train_model(learning_rate, steps, batch_size, input_feature, weight_array, bias_array):
  """Trains a linear regression model of one feature.
...
'''
 ...
 #   plt.plot(x_extents, y_extents, color=colors[period]) 
  ...
  print(input_feature)
  weight_array = weight_array.append(weight)
  bias_array = bias_array.append(bias)
  print("Weight:", weight)
  print("Bias:", bias)
...
for input_feature in my_feature:
    train_model(
    learning_rate=0.002,
    steps=2,
    batch_size=5,
    input_feature=input_feature, weight_array = weight_array, bias_array = bias_array)
